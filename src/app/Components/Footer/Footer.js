...
import { createStyles, Text, ActionIcon, Group, rem, Image, Button, Input, Container } from "@mantine/core";
        ...
        <Container size="lg" className={classes.inner}>
          <div>
            <div className={classes.logo}>
              <Image mb={18} src="https://i.ibb.co/M5vdV03/theme-footer-logo.png" alt="" srcset="" />
            </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Image maw={240} className={classes.app} src="https://i.ibb.co/KNVKW1v/app-store.png" alt="" srcset="" />
              <Image className={classes.app} src="https://i.ibb.co/FbWFzkh/play-store.png" alt="" srcset="" />
            </div>
            <Text className="flex gap-2 items-center text-white text-semibold " mt={25}>
